    ...
    while(1) {
        ...
        while (opcaoMenuPrincipal == 4) { // Simular insercoes de orgaos
            ...
            for (int i = 0; i < opcaoSimularInsercoes; i++) {
                ...
                if (orgao.tipo == 'C') {
                    printf("BFS: "); empilharOrgaosCentro(pilhasBFS, li_globalBFS, orgao, grafo, capitais, 'B');
                    printf("\tDFS: "); empilharOrgaosCentro(pilhasDFS, li_globalDFS, orgao, grafo, capitais, 'D');
                }
                else {
                    printf("BFS: "); enfileirarOrgaosCentro(filasBFS, li_globalBFS, orgao, grafo, capitais, 'B');
                    printf("\tDFS: "); enfileirarOrgaosCentro(filasDFS, li_globalDFS, orgao, grafo, capitais, 'D');
                }
            }
        ...
        while (opcaoMenuPrincipal == 5) { // Simular processamento de orgaos
            ...
            for (int i = 0; i < opcaoSimularProcessamento; i++) {
                ...
                printf("BFS: "); processarOrgao(grafo, filasBFS, pilhasBFS, li_globalBFS, verticeAleatProcessamento, capitais, tipoAleatProcessamento, 'B');
                printf("\tDFS: "); processarOrgao(grafo, filasDFS, pilhasDFS, li_globalDFS, verticeAleatProcessamento, capitais, tipoAleatProcessamento, 'D');
            }
